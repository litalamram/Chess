 ...
 * is given below:
 *
 * spArrayListNewNode	   - Creates a node with the specified parameters as its fields.
...
/**
 *  Creates a node with the specified fields.
 *  The node represents a valid move in the game
 *  @param startRow - the start row index of the move
 *  @param startCol - the start column index of the move
 *  @param destRow - the destination row index of the move
 *  @param destCol - the destination column index of the move
 *  @param capturedpiece - the piece that has been captured due to the move
 *  @return
 *  An instant of an array list node.
 */
